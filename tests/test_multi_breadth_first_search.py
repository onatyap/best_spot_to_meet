...
from solutions.multi_breadth_first_search_solution import MultiBreadthFirstSearchSolution
from utils.debug_utils import debug_test_start, debug_test_end, debug_test_output

problem_name = "MultiBreadthFirstSearch"


class MultiBreadthFirstSearchTests(unittest.TestCase):

    def test_multi_bfs_example01(self):
        debug_test_start(problem_name, 1)
        test_true = ['1 0 1 1',
                     '1 1 1 1']
        n, q, adj_list, friend_locations = read_input('example1.txt')
        solution = MultiBreadthFirstSearchSolution(n, q, adj_list, friend_locations)
    ...
    def test_multi_bfs_example02(self):
    ...
    def test_multi_bfs_example03(self):
    ...
    def test_multi_bfs_example04(self):
        ...
        solution = MultiBreadthFirstSearchSolution(n, q, node_connection_list, friend_locations)
    ...
    def test_multi_bfs_example05(self):
    ...
    def test_multi_bfs_example06(self):
    ...
    def test_multi_bfs_example07(self):
    ...
    def test_multi_bfs_example08(self):
    ...
    def test_multi_bfs_example09(self):
    ...
    def test_multi_bfs_example10(self):
